...
function fieldRemoved(type, field) {
    var entity = graphql_1.isInterfaceType(type) ? 'interface' : 'object type';
    return {
        criticality: {
        ...
        type: change_1.ChangeType.FieldRemoved,
...
function fieldAdded(type, field) {
    ...
    return {
        ...
        type: change_1.ChangeType.FieldAdded,
...
function fieldDescriptionChanged(type, oldField, newField) {
    return {
        ...
        type: change_1.ChangeType.FieldDescriptionChanged,
...
function fieldDescriptionAdded(type, field) {
    return {
        ...
        type: change_1.ChangeType.FieldDescriptionAdded,
...
function fieldDescriptionRemoved(type, field) {
    return {
        ...
        type: change_1.ChangeType.FieldDescriptionRemoved,
...
function fieldDeprecationAdded(type, field) {
    return {
        ...
        type: change_1.ChangeType.FieldDeprecationAdded,
...
function fieldDeprecationRemoved(type, field) {
    return {
        ...
        type: change_1.ChangeType.FieldDeprecationRemoved,
...
function fieldDeprecationReasonChanged(type, oldField, newField) {
    return {
        ...
        type: change_1.ChangeType.FieldDeprecationReasonChanged,
...
function fieldDeprecationReasonAdded(type, field) {
    return {
        ...
        type: change_1.ChangeType.FieldDeprecationReasonAdded,
...
function fieldDeprecationReasonRemoved(type, field) {
    return {
        ...
        type: change_1.ChangeType.FieldDeprecationReasonRemoved,
...
function fieldTypeChanged(type, oldField, newField) {
    return {
        criticality: {
            level: graphql_2.safeChangeForField(oldField.type, newField.type)
                ? change_1.CriticalityLevel.NonBreaking
                : change_1.CriticalityLevel.Breaking,
        },
        type: change_1.ChangeType.FieldTypeChanged,
...
function fieldArgumentAdded(type, field, arg) {
    return {
        criticality: graphql_1.isNonNullType(arg.type)
            ? {
                level: change_1.CriticalityLevel.Breaking,
        ...
        type: change_1.ChangeType.FieldArgumentAdded,
...
function fieldArgumentRemoved(type, field, arg) {
    return {
        ...
        type: change_1.ChangeType.FieldArgumentRemoved,
