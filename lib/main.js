...
function createCheck(tools) {
    return __awaiter(this, void 0, void 0, function* () {
        const { data } = yield tools.checks.create(Object.assign(Object.assign({}, github.context.repo), { head_sha: github.context.sha, name: github.context.action, started_at: new Date().toISOString(), status: 'in_progress' }));
        return data;
    });
}
